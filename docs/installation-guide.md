...
For families wanting comprehensive content filtering with admin-controlled age rating controls (where admins can set different rating limits for each individual user):
